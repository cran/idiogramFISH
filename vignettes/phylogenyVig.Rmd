...
bibliography: [allrefs.bib, packages.bib, iqtree.bib,revbayes.bib]
csl: climaMod.csl
link-citations: yes
resource_files:
  - secondplot.png
...
# params:
  # packageCheck: FALSE
vignette: >
  %\VignetteIndexEntry{Plotting alongside phylogeny}
...
idiogramFISH comes with two trees, first we will plot a tree produced with iqtree [@Nguyen2015c]

## Load the iqtree: {-}

We will use phytools for that [@R-phytools]
...
## Make a ggtree [@R-ggtree] {-}

```{r, message=FALSE, eval=packageCheck}
ggtreeOf8 <- ggtree(iqtreephyloUM) + geom_tiplab(size=6)
```

Modify optionally graphical parameters with ggplot and ggpubr: [@R-ggplot2; @R-ggpubr]
...
```{r, results="asis", comment=NA, echo=FALSE, eval=T}
if(packageCheck){
