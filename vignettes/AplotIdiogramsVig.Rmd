...
#bibliography_normal: [refs/allrefs.bib]
#bibliography_software: [refs/allrefs.bib]
...
vignette: >
  %\VignetteIndexEntry{1. Plotting chromosomes I}
...
Go to [4. Human Vignette](EhumanVig.html)  
...
```{r example_M1, echo=TRUE, results="hide", fig.width=12, fig.height=6, message=FALSE, dev='png'}
...
```{r example_M1cen0, echo=TRUE, results="hide", fig.width=4.5, fig.height=4.5, message=FALSE,dev='png'}
...
```{r, echo=TRUE, results="asis", fig.width=9, fig.height=9, message=FALSE,dev='png', eval=TRUE}
...
```{r, echo=TRUE, results="hide", fig.width=7, fig.height=7, message=FALSE,dev='png', warning=FALSE, eval=FALSE}
...
## Use cM instead of Mb (devel. version > 1.12)
