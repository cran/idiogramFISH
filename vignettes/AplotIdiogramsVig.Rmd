...
vignette: >
  %\VignetteIndexEntry{1. Plotting chromosomes}
...
For help on Citrus karyotypes, visit: 
[https://ferroao.gitlab.io/idiogramfishhelppages/citrushelp.html](https://ferroao.gitlab.io/idiogramfishhelppages/citrushelp.html){target="_blank"}

## Load package

visit gitlab for installation instructions [https://gitlab.com/ferroao/idiogramFISH](https://gitlab.com/ferroao/idiogramFISH){target="_blank"}
...
```{r , echo=TRUE, results="hide", fig.width=12, fig.height=6, message=FALSE, dev='png'}
...
```{r cen0, echo=TRUE, results="hide", fig.width=4.5, fig.height=4.5, message=FALSE,dev='png'}
...
```{r, echo=TRUE, results="hide", fig.width=10, fig.height=4.5, message=FALSE,dev="png", eval=TRUE}
...
dev.off() # close png
```
```{r hidethiscran, results="asis", comment=NA, echo=FALSE, eval=TRUE}
...
```{r example, echo=TRUE, results="hide", fig.width=13.5, fig.height=6, message=FALSE, dev="png", eval=TRUE}
# library(idiogramFISH)
...
```{r, echo=TRUE, comment="#", fig.width=6, fig.height=3, message=FALSE,dev='png', collapse=TRUE}
...
```{r, echo=TRUE, results="hide", fig.width=13.5, fig.height=6, message=FALSE, dev='png'}
...
```{r example3, echo=TRUE, results="hide", fig.width=6, fig.height=6, message=FALSE,dev='png'}
library(idiogramFISH)
...
```{r , echo=TRUE, results="hide", fig.width=8, fig.height=7, message=FALSE,dev='png'}
...
```{r example4, echo=TRUE, results="hide", fig.width=6, fig.height=6, message=FALSE,dev='png'}
...
```{r, echo=TRUE, results="hide", fig.width=7, fig.height=7, message=FALSE,dev='png', warning=FALSE, eval=TRUE}
...
```{r, echo=TRUE, fig.width=10, fig.height=10, message=FALSE,dev='png', warning=FALSE,collapse=TRUE, comment="#"}
...
```{r, echo=TRUE, results="hide", fig.width=10, fig.height=10, message=FALSE,dev='png', warning=FALSE}
#fig.width=10, fig.height=10
