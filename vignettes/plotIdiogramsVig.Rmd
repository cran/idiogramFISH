---
title: "Plotting monocentric chromosomes"
author: "Fernando Roa"
date: "23 08 2019"
output:
...
link-citations: yes
vignette: >
  %\VignetteIndexEntry{Plotting monocentric chromosomes}
...
```{r example_M1, echo=TRUE, results="hide", fig.width=7, fig.height=4.5, message=FALSE}
...
```{r example_M1cen0, echo=TRUE, results="hide", fig.width=7, fig.height=4.5, message=FALSE}
# fig.width=7, fig.height=4.5
...
```{r example_M3, echo=TRUE, results="hide", fig.width=6, fig.height=13, message=FALSE}
# library(idiogramFISH)
