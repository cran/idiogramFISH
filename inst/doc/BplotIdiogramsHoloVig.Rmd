...
#  - mydfChrSizeHolo.svg
vignette: >
  %\VignetteIndexEntry{2. Plotting chromosomes II}
...
```{r example, echo=TRUE, results="hide", fig.width=13.5, fig.height=6, message=FALSE, dev='png'}
# library(idiogramFISH)
