...
```{r, echo=TRUE, results="hide", fig.width=10, fig.height=7, message=FALSE,dev='png', eval=FALSE}
{
...
```{r, echo=FALSE, results="hide", fig.width=10, fig.height=7, message=FALSE,dev='png', eval=TRUE}
{
  require(idiogramFISH)
  require(plyr)
  dfOfChrSize$OTU   <- "Species mono"
