...
link-citations: yes
vignette: >
  %\VignetteIndexEntry{Human karyotype}
...
<!--   %\VignetteEngine{knitr::rmarkdown} -->
<!--   %\VignetteEncoding{UTF-8} -->
<!-- bibliography: idiogramFISHcitations.bib -->
<!-- --- -->
...
``` {r hkaryo, echo=TRUE, fig.width=10, fig.height=28, message=FALSE, results="hide"}
...
```{r hsel, echo=TRUE, fig.width=6, fig.height=6, message=FALSE, results="hide"}
...
```{r hsel2, echo=TRUE, fig.width=6, fig.height=6, message=FALSE, results="hide"}
